...
export default function Home() {
  ...
  return (
    <main className="min-h-screen pt-24 pb-4 px-4 md:px-8 max-w-7xl mx-auto flex flex-col justify-center">
      ...
      <div className={`grid grid-cols-1 ${isPlaying ? 'lg:grid-cols-[1fr_320px]' : 'lg:grid-cols-1'} gap-8 items-center transition-all duration-500`}>
        ...
        <div className="flex flex-col items-center gap-4 lg:gap-8">
            ...
            {!isPlaying ? (
                ...
                <div className="flex flex-col items-center gap-4 animate-in zoom-in-95 fade-in duration-500 w-full max-w-lg">
                    {/* Compact Mobile HUD */}
        ...
        {/* Desktop Sidebar - Only show when playing */}
        {isPlaying && (
            <div className="sticky top-24 hidden lg:block animate-in slide-in-from-right-10 fade-in duration-700">
                <Sidebar />
            </div>
        )}
      </div>
